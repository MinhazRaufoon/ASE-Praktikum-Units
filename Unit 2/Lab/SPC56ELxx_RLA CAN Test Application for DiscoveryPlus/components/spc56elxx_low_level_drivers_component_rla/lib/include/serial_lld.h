 ...
 */
/**
 * @brief   LINFlex Serial driver buffered IO mode enable switch.
 * @details If set to @p TRUE the buffered io support for is included.
 */
#if !defined(SPC5_SERIAL_BUFFERED_IO) || defined(__DOXYGEN__)
...
#if (SPC5_SERIAL_BUFFERED_IO == TRUE)
  /**
   * @brief   RX Buffer.
   */
