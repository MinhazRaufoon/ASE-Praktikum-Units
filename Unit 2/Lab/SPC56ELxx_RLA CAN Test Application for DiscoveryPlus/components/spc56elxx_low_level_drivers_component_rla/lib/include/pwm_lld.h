 ...
 * @note    The default is @p FALSE.
 */
#if !defined(SPC5_PWM_USE_SMOD8) || defined(__DOXYGEN__)
#define SPC5_PWM_USE_SMOD8                  FALSE
#endif
 ...
 * @note    The default is @p FALSE.
 */
#if !defined(SPC5_PWM_USE_SMOD9) || defined(__DOXYGEN__)
#define SPC5_PWM_USE_SMOD9                  FALSE
#endif
 ...
 * @note    The default is @p FALSE.
 */
#if !defined(SPC5_PWM_USE_SMOD10) || defined(__DOXYGEN__)
#define SPC5_PWM_USE_SMOD10                 FALSE
#endif
 ...
 * @note    The default is @p FALSE.
 */
#if !defined(SPC5_PWM_USE_SMOD11) || defined(__DOXYGEN__)
#define SPC5_PWM_USE_SMOD11                 FALSE
#endif

/**
 * @brief   FlexPWM2 synchronization enable switch.
 * @details If set to @p TRUE the FlexPWM1 synchronization is enabled.
 * @note    The default is @p FALSE.
 */
#if !defined(SPC5_PWM2_USE_SYNC_SMOD) || defined(__DOXYGEN__)
#define SPC5_PWM2_USE_SYNC_SMOD              FALSE
#endif

/**
 * @brief   PWMD9 interrupt priority level setting.
 */
#if !defined(SPC5_PWM_SMOD8_PRIORITY) || defined(__DOXYGEN__)
#define SPC5_PWM_SMOD8_PRIORITY             7
#endif

/**
 * @brief   PWMD10 interrupt priority level setting.
 */
#if !defined(SPC5_PWM_SMOD9_PRIORITY) || defined(__DOXYGEN__)
#define SPC5_PWM_SMOD9_PRIORITY             7
#endif

/**
 * @brief   PWMD11 interrupt priority level setting.
 */
#if !defined(SPC5_PWM_SMOD10_PRIORITY) || defined(__DOXYGEN__)
#define SPC5_PWM_SMOD10_PRIORITY            7
#endif

/**
 * @brief   PWMD12 interrupt priority level setting.
 */
#if !defined(SPC5_PWM_SMOD11_PRIORITY) || defined(__DOXYGEN__)
#define SPC5_PWM_SMOD11_PRIORITY            7
#endif

/**
 * @brief   FlexPWM-2 peripheral configuration when started.
 * @note    The default configuration is 1 (always run) in run mode and
 *          2 (only halt) in low power mode.
 */
#if !defined(SPC5_PWM_FLEXPWM2_START_PCTL) || defined(__DOXYGEN__)
#define SPC5_PWM_FLEXPWM2_START_PCTL        (SPC5_ME_PCTL_RUN(1) |          \
                                             SPC5_ME_PCTL_LP(2))
#endif

/**
 * @brief   FlexPWM-2 peripheral configuration when stopped.
 * @note    The default configuration is 0 (never run) in run mode and
 *          0 (never run) in low power mode.
 */
#if !defined(SPC5_PWM_FLEXPWM2_STOP_PCTL) || defined(__DOXYGEN__)
#define SPC5_PWM_FLEXPWM2_STOP_PCTL         (SPC5_ME_PCTL_RUN(0) |          \
                                             SPC5_ME_PCTL_LP(0))
#endif
...
#define SPC5_PWM_USE_FLEXPWM2               TRUE
#else
#define SPC5_PWM_USE_FLEXPWM2               FALSE
#endif
...
#if (SPC5_HAS_FLEXPWM2 == FALSE && SPC5_PWM_USE_FLEXPWM2 == TRUE)
#error "FlexPWM2 not present in the selected device"
#endif

#if (SPC5_PWM_USE_FLEXPWM0 == FALSE && SPC5_PWM_USE_FLEXPWM1 == FALSE && \
     SPC5_PWM_USE_FLEXPWM2 == FALSE)
...
#if (SPC5_PWM2_USE_SYNC_SMOD == TRUE && SPC5_PWM_USE_SMOD8 == FALSE)
#error "FlexPWM2 sm0 must be activated when FlexPWM2 submodule synchronization is activated"
#endif
...
/**
 * @brief   PWM clock type.
 */
typedef uint32_t pwmclk_t;
