 ...
 */
#if (SPC5_PWM_USE_SMOD8 == TRUE) || defined(__DOXYGEN__)
PWMDriver PWMD9;
#endif
 ...
 */
#if (SPC5_PWM_USE_SMOD9 == TRUE && SPC5_PWM2_USE_SYNC_SMOD == FALSE) || defined(__DOXYGEN__)
PWMDriver PWMD10;
#endif
 ...
 */
#if (SPC5_PWM_USE_SMOD10 == TRUE && SPC5_PWM2_USE_SYNC_SMOD == FALSE) || defined(__DOXYGEN__)
PWMDriver PWMD11;
#endif
 ...
 */
#if (SPC5_PWM_USE_SMOD11 == TRUE && SPC5_PWM2_USE_SYNC_SMOD == FALSE) || defined(__DOXYGEN__)
PWMDriver PWMD12;
#endif
...
/**
 * @brief   Number of active FlexPWM2 submodules.
 * @note    When SPC5_PWM2_USE_SYNC_SMOD is TRUE if the FlexPWM2 submodules are
 *          active, flexpwm_active_submodules1 = 1.
 */
#if (SPC5_PWM_USE_SMOD8 == TRUE)  || (SPC5_PWM_USE_SMOD9 == TRUE) || \
    (SPC5_PWM_USE_SMOD10 == TRUE) || (SPC5_PWM_USE_SMOD11 == TRUE)
static uint32_t flexpwm_active_submodules2;
#endif
...
/* Retrieve the channel a/b of the submodule sid when the channel 
...
#if (SPC5_PWM2_USE_SYNC_SMOD == TRUE)
  if (&PWMD9 == pwmp) {    
    cha = (uint8_t)(2U * sid);
    chb = (uint8_t)(2U * sid + 1U);
  }
  ...
  psc = (uint32_t)(pwmp->clock) / pwmp->config->frequency;
...
static void pwm_lld_enable_submodule_channel(PWMDriver *pwmp,
  ...
  /* Activates the width interrupt.*/
    ...
    case PWM_ALIGN_EDGE:
      if (width >= (pwmperiod / 2U)) {
        pwmp->flexpwmp->SUB[sid].VAL[5].R = width - (pwmperiod / 2U);
      } else {
...
#if (SPC5_PWM_USE_SMOD9 == TRUE && SPC5_PWM2_USE_SYNC_SMOD == FALSE)
  if (&PWMD10 == pwmp) {
    if (pwmp->flexpwmp->SUB[sid].INTEN.B.RIE != 1U) {
      if (pwmp->config->callback != NULL) {
        pwmp->flexpwmp->SUB[sid].INTEN.B.RIE = 1;
...
#if (SPC5_PWM_USE_SMOD10 == TRUE && SPC5_PWM2_USE_SYNC_SMOD == FALSE)
  if (&PWMD11 == pwmp) {
    if (pwmp->flexpwmp->SUB[sid].INTEN.B.RIE != 1U) {
      if (pwmp->config->callback != NULL) {
        pwmp->flexpwmp->SUB[sid].INTEN.B.RIE = 1;
...
#if (SPC5_PWM_USE_SMOD11 == TRUE && SPC5_PWM2_USE_SYNC_SMOD == FALSE)
  if (&PWMD12 == pwmp) {
    if (pwmp->flexpwmp->SUB[sid].INTEN.B.RIE != 1U) {
      if (pwmp->config->callback != NULL) {
        pwmp->flexpwmp->SUB[sid].INTEN.B.RIE = 1;
...
static void pwm_lld_disable_submodule_channel(PWMDriver *pwmp,
  ...
  if (((maska & (1U << sid)) != 0U) && ((maskb & (1U << sid)) == 1U)) {
    ...
    pwmp->flexpwmp->SUB[sid].STS.R = 0x1000U;
  }
...
/* Retrieve the channel a/b of the submodule sid when the channel 
  ...
  if ((sr & SPC5_FLEXPWM_STS_CMPF3) != 0U) {
    /* Clear CMPF3 flag.*/
    pwmp->flexpwmp->SUB[sid].STS.R |= 0x0008U;
    if (pwmp->config->channels[cha].callback != NULL) {
      pwmp->config->channels[cha].callback(pwmp);
    }
  }
  if ((sr & SPC5_FLEXPWM_STS_CMPF5) != 0U) {
    /* Clear CMPF3 flag.*/
    pwmp->flexpwmp->SUB[sid].STS.R |= 0x0020U;
    if (pwmp->config->channels[chb].callback != NULL) {
  ...
  if ((sr & SPC5_FLEXPWM_STS_RF) != 0U) {
    /* Clear RF flag.*/
    pwmp->flexpwmp->SUB[sid].STS.R = 0x1000U;
    /* If the synchronization is enabled, the period
       callback is invoked only for sid = 0. */
#if (SPC5_PWM0_USE_SYNC_SMOD == TRUE)
    if (&PWMD1 == pwmp && sid != 0U) {
      return;
    }
...
#error "SPC5_FLEXPWM1_RF0_HANDLER not defined"
#endif
/**
...
#if (SPC5_PWM_USE_SMOD8 == TRUE) || defined(__DOXYGEN__)
#if !defined(SPC5_FLEXPWM2_RF0_HANDLER)
#error "SPC5_FLEXPWM2_RF0_HANDLER not defined"
#endif
/**
 * @brief   FlexPWM2-SMOD0 RF0 interrupt handler.
 *
 * @isr
 */
IRQ_HANDLER(SPC5_FLEXPWM2_RF0_HANDLER) {

  IRQ_PROLOGUE();

  pwm_lld_serve_interrupt(&PWMD9, 0);

  IRQ_EPILOGUE();
}

#if !defined(SPC5_FLEXPWM2_COF0_HANDLER)
#error "SPC5_FLEXPWM2_COF0_HANDLER not defined"
#endif
/**
 * @brief   FlexPWM2-SMOD0 COF0 interrupt handler.
 *
 * @isr
 */
IRQ_HANDLER(SPC5_FLEXPWM2_COF0_HANDLER) {
...
#if (SPC5_PWM_USE_SMOD9 == TRUE) || defined(__DOXYGEN__)
#if (SPC5_PWM2_USE_SYNC_SMOD == FALSE)
#if !defined(SPC5_FLEXPWM2_RF1_HANDLER)
#error "SPC5_FLEXPWM2_RF1_HANDLER not defined"
#endif
/**
 * @brief   FlexPWM2-SMOD1 RF1 interrupt handler.
 *
 * @isr
 */
IRQ_HANDLER(SPC5_FLEXPWM2_RF1_HANDLER) {

  IRQ_PROLOGUE();

  pwm_lld_serve_interrupt(&PWMD10, 1);

  IRQ_EPILOGUE();
}
#endif

#if !defined(SPC5_FLEXPWM2_COF1_HANDLER)
#error "SPC5_FLEXPWM2_COF1_HANDLER not defined"
#endif
/**
 * @brief   FlexPWM2-SMOD1 COF1 interrupt handler.
 *
 * @isr
 */
IRQ_HANDLER(SPC5_FLEXPWM2_COF1_HANDLER) {
  ...
  pwm_lld_serve_interrupt(&PWMD10, 1);
#else
  pwm_lld_serve_interrupt(&PWMD9, 1);
#endif
...
#if (SPC5_PWM_USE_SMOD10 == TRUE) || defined(__DOXYGEN__)
#if (SPC5_PWM2_USE_SYNC_SMOD == FALSE)
#if !defined(SPC5_FLEXPWM2_RF2_HANDLER)
#error "SPC5_FLEXPWM2_RF2_HANDLER not defined"
#endif
/**
 * @brief   FlexPWM2-SMOD2 RF2 interrupt handler.
 *
 * @isr
 */
IRQ_HANDLER(SPC5_FLEXPWM2_RF2_HANDLER) {

  IRQ_PROLOGUE();

  pwm_lld_serve_interrupt(&PWMD11, 2);

  IRQ_EPILOGUE();
}
#endif

#if !defined(SPC5_FLEXPWM2_COF2_HANDLER)
#error "SPC5_FLEXPWM2_COF2_HANDLER not defined"
#endif
/**
 * @brief   FlexPWM2-SMOD2 COF2 interrupt handler.
 *
 * @isr
 */
IRQ_HANDLER(SPC5_FLEXPWM2_COF2_HANDLER) {
  ...
  pwm_lld_serve_interrupt(&PWMD11, 2);
#else
  pwm_lld_serve_interrupt(&PWMD9, 2);
#endif
...
#if (SPC5_PWM_USE_SMOD11 == TRUE) || defined(__DOXYGEN__)
#if (SPC5_PWM2_USE_SYNC_SMOD == FALSE)
#if !defined(SPC5_FLEXPWM2_RF3_HANDLER)
#error "SPC5_FLEXPWM2_RF3_HANDLER not defined"
#endif
/**
 * @brief   FlexPWM2-SMOD3 RF3 interrupt handler.
 *
 * @isr
 */
IRQ_HANDLER(SPC5_FLEXPWM2_RF3_HANDLER) {

  IRQ_PROLOGUE();

  pwm_lld_serve_interrupt(&PWMD12, 3);

  IRQ_EPILOGUE();
}
#endif

#if !defined(SPC5_FLEXPWM2_COF3_HANDLER)
#error "SPC5_FLEXPWM2_COF3_HANDLER not defined"
#endif
/**
 * @brief   FlexPWM2-SMOD3 COF3 interrupt handler.
 *
 * @isr
 */
IRQ_HANDLER(SPC5_FLEXPWM2_COF3_HANDLER) {
  ...
  pwm_lld_serve_interrupt(&PWMD12, 3);
#else
  pwm_lld_serve_interrupt(&PWMD9, 3);
#endif
...
void pwm_lld_init(void) {
...
#if (SPC5_PWM_USE_SMOD8 == TRUE)  || (SPC5_PWM_USE_SMOD9 == TRUE) || \
    (SPC5_PWM_USE_SMOD10 == TRUE) || (SPC5_PWM_USE_SMOD11 == TRUE)
  flexpwm_active_submodules2 = 0U;
#endif

#if (SPC5_PWM_USE_SMOD0 == TRUE)
  /* Driver initialization.*/
  PWMD1.config = NULL;
  PWMD1.clock = SPC5_FLEXPWM0_CLK;
  PWMD1.flexpwmp = &SPC5_FLEXPWM_0;
  INTC_PSR(SPC5_FLEXPWM0_RF0_NUMBER) = SPC5_PWM_SMOD0_PRIORITY;
  INTC_PSR(SPC5_FLEXPWM0_COF0_NUMBER) = SPC5_PWM_SMOD0_PRIORITY;
#endif
  ...
  /* Driver initialization.*/
  PWMD2.config = NULL;
  PWMD2.clock = SPC5_FLEXPWM0_CLK;
  PWMD2.flexpwmp = &SPC5_FLEXPWM_0;
  INTC_PSR(SPC5_FLEXPWM0_RF1_NUMBER) = SPC5_PWM_SMOD1_PRIORITY;
#endif
  INTC_PSR(SPC5_FLEXPWM0_COF1_NUMBER) = SPC5_PWM_SMOD1_PRIORITY;
#endif
  ...
  /* Driver initialization.*/
  PWMD3.config = NULL;
  PWMD3.clock = SPC5_FLEXPWM0_CLK;
  PWMD3.flexpwmp = &SPC5_FLEXPWM_0;
  INTC_PSR(SPC5_FLEXPWM0_RF2_NUMBER) = SPC5_PWM_SMOD2_PRIORITY;
#endif
  INTC_PSR(SPC5_FLEXPWM0_COF2_NUMBER) = SPC5_PWM_SMOD2_PRIORITY;
#endif
  ...
  /* Driver initialization.*/
  PWMD4.config = NULL;
  PWMD4.clock = SPC5_FLEXPWM0_CLK;
  PWMD4.flexpwmp = &SPC5_FLEXPWM_0;
  INTC_PSR(SPC5_FLEXPWM0_RF3_NUMBER) = SPC5_PWM_SMOD3_PRIORITY;
#endif
  INTC_PSR(SPC5_FLEXPWM0_COF3_NUMBER) = SPC5_PWM_SMOD3_PRIORITY;
#endif

#if (SPC5_PWM_USE_SMOD4 == TRUE)
  /* Driver initialization.*/
  PWMD5.config = NULL;
  PWMD5.clock = SPC5_FLEXPWM1_CLK;
  PWMD5.flexpwmp = &SPC5_FLEXPWM_1;
  INTC_PSR(SPC5_FLEXPWM1_RF0_NUMBER) = SPC5_PWM_SMOD4_PRIORITY;
  INTC_PSR(SPC5_FLEXPWM1_COF0_NUMBER) = SPC5_PWM_SMOD4_PRIORITY;
#endif
  ...
  /* Driver initialization.*/
  PWMD6.config = NULL;
  PWMD6.clock = SPC5_FLEXPWM1_CLK;
  PWMD6.flexpwmp = &SPC5_FLEXPWM_1;
  INTC_PSR(SPC5_FLEXPWM1_RF1_NUMBER) = SPC5_PWM_SMOD5_PRIORITY;
#endif
  INTC_PSR(SPC5_FLEXPWM1_COF1_NUMBER) = SPC5_PWM_SMOD5_PRIORITY;
#endif
  ...
  /* Driver initialization.*/
  PWMD7.config = NULL;
  PWMD7.clock = SPC5_FLEXPWM1_CLK;
  PWMD7.flexpwmp = &SPC5_FLEXPWM_1;
  INTC_PSR(SPC5_FLEXPWM1_RF2_NUMBER) = SPC5_PWM_SMOD6_PRIORITY;
#endif
  INTC_PSR(SPC5_FLEXPWM1_COF2_NUMBER) = SPC5_PWM_SMOD6_PRIORITY;
#endif
  ...
  /* Driver initialization.*/
  PWMD8.config = NULL;
  PWMD8.clock = SPC5_FLEXPWM1_CLK;
  PWMD8.flexpwmp = &SPC5_FLEXPWM_1;
  INTC_PSR(SPC5_FLEXPWM1_RF3_NUMBER) = SPC5_PWM_SMOD7_PRIORITY;
#endif
  INTC_PSR(SPC5_FLEXPWM1_COF3_NUMBER) = SPC5_PWM_SMOD7_PRIORITY;
#endif

#if (SPC5_PWM_USE_SMOD8 == TRUE)
  /* Driver initialization.*/
  PWMD9.config = NULL;
  PWMD9.clock = SPC5_FLEXPWM2_CLK;
  PWMD9.flexpwmp = &SPC5_FLEXPWM_2;
  INTC_PSR(SPC5_FLEXPWM2_RF0_NUMBER) = SPC5_PWM_SMOD8_PRIORITY;
  INTC_PSR(SPC5_FLEXPWM2_COF0_NUMBER) = SPC5_PWM_SMOD8_PRIORITY;
#endif

#if (SPC5_PWM_USE_SMOD9 == TRUE)
#if (SPC5_PWM2_USE_SYNC_SMOD == FALSE)
  /* Driver initialization.*/
  PWMD10.config = NULL;
  PWMD10.clock = SPC5_FLEXPWM2_CLK;
  PWMD10.flexpwmp = &SPC5_FLEXPWM_2;
  INTC_PSR(SPC5_FLEXPWM2_RF1_NUMBER) = SPC5_PWM_SMOD9_PRIORITY;
#endif
  INTC_PSR(SPC5_FLEXPWM2_COF1_NUMBER) = SPC5_PWM_SMOD9_PRIORITY;
#endif

#if (SPC5_PWM_USE_SMOD10 == TRUE)
#if (SPC5_PWM2_USE_SYNC_SMOD == FALSE)
  /* Driver initialization.*/
  PWMD11.config = NULL;
  PWMD11.clock = SPC5_FLEXPWM2_CLK;
  PWMD11.flexpwmp = &SPC5_FLEXPWM_2;
  INTC_PSR(SPC5_FLEXPWM2_RF2_NUMBER) = SPC5_PWM_SMOD10_PRIORITY;
#endif
  INTC_PSR(SPC5_FLEXPWM2_COF2_NUMBER) = SPC5_PWM_SMOD10_PRIORITY;
#endif

#if (SPC5_PWM_USE_SMOD11 == TRUE)
#if (SPC5_PWM2_USE_SYNC_SMOD == FALSE)
  /* Driver initialization.*/
  PWMD12.config = NULL;
  PWMD12.clock = SPC5_FLEXPWM2_CLK;
  PWMD12.flexpwmp = &SPC5_FLEXPWM_2;
  INTC_PSR(SPC5_FLEXPWM2_RF3_NUMBER) = SPC5_PWM_SMOD11_PRIORITY;
#endif
  INTC_PSR(SPC5_FLEXPWM2_COF3_NUMBER) = SPC5_PWM_SMOD11_PRIORITY;
#endif
...
#if (SPC5_PWM_USE_SMOD8 == TRUE)
  if (&PWMD9 == pwmp) {
    flexpwm_active_submodules2++;
  }
#endif /* SPC5_PWM_USE_SMOD8 */

#if (SPC5_PWM_USE_SMOD9 == TRUE && SPC5_PWM2_USE_SYNC_SMOD == FALSE)
  if (&PWMD10 == pwmp) {
    flexpwm_active_submodules2++;
  }
#endif /* (SPC5_PWM_USE_SMOD9 && !(SPC5_PWM2_USE_SYNC_SMOD)) */

#if (SPC5_PWM_USE_SMOD10 == TRUE && SPC5_PWM2_USE_SYNC_SMOD == FALSE)
  if (&PWMD11 == pwmp) {
    flexpwm_active_submodules2++;
  }
#endif /* (SPC5_PWM_USE_SMOD10 && !(SPC5_PWM2_USE_SYNC_SMOD)) */

#if (SPC5_PWM_USE_SMOD11 == TRUE && SPC5_PWM2_USE_SYNC_SMOD == FALSE)
  if (&PWMD12 == pwmp) {
    flexpwm_active_submodules2++;
  }
#endif /* (SPC5_PWM_USE_SMOD11 && !(SPC5_PWM2_USE_SYNC_SMOD)) */
...
#if (SPC5_PWM_USE_FLEXPWM2 == TRUE)
  /* If this is the first FlexPWM2 submodule activated, sets Peripheral Clock.*/
  if (flexpwm_active_submodules2 == 1U) {
    SPCSetPeripheralClockMode(SPC5_FLEXPWM2_PCTL,
        SPC5_PWM_FLEXPWM2_START_PCTL);
  }
#endif
...
#if (SPC5_PWM_USE_FLEXPWM2 == TRUE)
  /* Disables peripheral clock if there is not an activated module.*/
  if (flexpwm_active_submodules2 == 0U) {
    SPCSetPeripheralClockMode(SPC5_FLEXPWM2_PCTL,
                                 SPC5_PWM_FLEXPWM2_STOP_PCTL);
  }
#endif
