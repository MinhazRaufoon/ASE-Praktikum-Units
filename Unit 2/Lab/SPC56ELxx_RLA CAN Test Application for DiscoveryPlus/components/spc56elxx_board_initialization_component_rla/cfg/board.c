...
static const spc_siu_init_t spc_siu_init[] = {
  {(int32_t)PCR_INDEX(PORT_A, PA_LED5), PAL_HIGH,   (iomode_t)(PAL_MODE_OUTPUT_PUSHPULL)},
  {(int32_t)PCR_INDEX(PORT_A, PA_LED6), PAL_HIGH,   (iomode_t)(PAL_MODE_OUTPUT_PUSHPULL)},
  {(int32_t)PCR_INDEX(PORT_G, PG_LED7), PAL_HIGH,   (iomode_t)(PAL_MODE_OUTPUT_PUSHPULL)},
  {-1, 0, 0}
};
