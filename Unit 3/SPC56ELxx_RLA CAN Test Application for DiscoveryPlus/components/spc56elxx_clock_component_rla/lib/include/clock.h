...
/**
 * @file    clock.h
 * @brief   SPC56ELxx clock subsystem header
 *
 * @addtogroup CLOCK
 * @{
 */
 ...
 * @brief   Maximum FMPLLs input clock frequency.
 */
#define SPC5_FMPLLIN_MAX            40000000U
 ...
 */
#define SPC5_FMPLL0_CLK_MAX         120000000U
 ...
 */
#define SPC5_FMPLL1_1D1_CLK_MAX     80000000U
/** @} */
 ...
 * @{
 */
#define SPC5_FMPLL_SRC_IRC          (0UL << 24)
#define SPC5_FMPLL_SRC_XOSC         (1UL << 24)
/** @} */
...
#define SPC5_CGM_SS_FMPLL1_1D1      (8UL << 24)
/** @} */
...
#define SPC5_ME_MC_FLAON_MASK       ((3UL << 16) | (3UL << 18))
#define SPC5_ME_MC_FLAON(n)         ((((uint32_t)(n)) << 16) | (((uint32_t)(n)) << 18))
#define SPC5_ME_MC_FLAON_PD         ((1UL << 16) | (1UL << 18))
#define SPC5_ME_MC_FLAON_LP         ((2UL << 16) | (2UL << 18))
#define SPC5_ME_MC_FLAON_NORMAL     ((3UL << 16) | (3UL << 18))
...
#define SPC5_FMPLL0_NDIV_VALUE              60U
#endif
...
#define SPC5_SYSCLK_DIVIDER_VALUE           2U
#endif
...
#define SPC5_SWG_DIVIDER_VALUE              2U
#endif
...
#define SPC5_FLEXRAY_DIVIDER_VALUE          2U
#endif
...
#define SPC5_FLEXCAN_DIVIDER_VALUE          2U
#endif
...
#elif (SPC5_SYSCLK_DIVIDER_VALUE >= 1U) && (SPC5_SYSCLK_DIVIDER_VALUE <= 16U)
#define SPC5_CGM_SC_DC0         (0x80U | (uint32_t)(SPC5_SYSCLK_DIVIDER_VALUE - 1U))
#else
...
#define SPC5_CGM_AC0_DC0        ((0x80U | (uint32_t)(SPC5_MCONTROL_DIVIDER_VALUE - 1U)) << 24U)
#else
#error "invalid SPC5_MCONTROL_DIVIDER_VALUE value specified"
#endif

/* Check on the AUX0 divider 1 settings.*/
#if (SPC5_SWG_DIVIDER_VALUE == 0U)
#define SPC5_CGM_AC0_DC1        0U
#elif (SPC5_SWG_DIVIDER_VALUE >= 1U) && (SPC5_SWG_DIVIDER_VALUE <= 16U)
#define SPC5_CGM_AC0_DC1        ((0x80U | (uint32_t)(SPC5_SWG_DIVIDER_VALUE - 1U)) << 16U)
#else
...
#else
#define SPC5_MCONTROL_CLK       0U
#endif

/**
 * @brief   SWG clock point.
 */
#if (SPC5_SWG_DIVIDER_VALUE != 0U) || defined(__DOXYGEN)
#define SPC5_SWG_CLK            (SPC5_AUX0_CLK / SPC5_SWG_DIVIDER_VALUE)
#else
#define SPC5_SWG_CLK            0U
#endif
...
#if (SPC5_FLEXRAY_DIVIDER_VALUE == 0U)
#define SPC5_CGM_AC1_DC0        0U
#elif (SPC5_FLEXRAY_DIVIDER_VALUE >= 1U) && (SPC5_FLEXRAY_DIVIDER_VALUE <= 16U)
#define SPC5_CGM_AC1_DC0        ((0x80U | (uint32_t)(SPC5_FLEXRAY_DIVIDER_VALUE - 1U)) << 24U)
#else
 ...
 */
#if (SPC5_FLEXRAY_DIVIDER_VALUE != 0U) || defined(__DOXYGEN)
#define SPC5_FLEXRAY_CLK        (SPC5_AUX2_CLK / SPC5_FLEXRAY_DIVIDER_VALUE)
#else
#define SPC5_FLEXRAY_CLK        0U
#endif
...
#if SPC5_FLEXCAN_DIVIDER_VALUE == 0U
#define SPC5_CGM_AC2_DC0        0U
#elif (SPC5_FLEXCAN_DIVIDER_VALUE >= 1U) && (SPC5_FLEXCAN_DIVIDER_VALUE <= 16U)
#define SPC5_CGM_AC2_DC0        ((0x80U | (uint32_t)(SPC5_FLEXCAN_DIVIDER_VALUE - 1U)) << 24U)
#else
 ...
 */
#if (SPC5_FLEXCAN_DIVIDER_VALUE != 0U) || defined(__DOXYGEN)
#define SPC5_FLEXCAN_CLK        (SPC5_AUX2_CLK / SPC5_FLEXCAN_DIVIDER_VALUE)
#else
#define SPC5_FLEXCAN_CLK        0U
#endif
