...
#if (SPC5_SPI_DSPI8_SLAVE == TRUE)
  SPC5_DSPI8.MCR.R  = SPC5_MCR_HALT | SPC5_MCR_MDIS | SPC5_SPI_DSPI8_MCR;
#else
  SPC5_DSPI8.MCR.R  = SPC5_MCR_MSTR | SPC5_MCR_HALT | SPC5_MCR_MDIS |
                      SPC5_SPI_DSPI8_MCR;
#endif
#if (SPC5_SPI_DMA_MODE == SPC5_SPI_DMA_NONE)
...
#if (SPC5_SPI_DSPI9_SLAVE == TRUE)
  SPC5_DSPI9.MCR.R  = SPC5_MCR_HALT | SPC5_MCR_MDIS | SPC5_SPI_DSPI9_MCR;
#else
  SPC5_DSPI9.MCR.R  = SPC5_MCR_MSTR | SPC5_MCR_HALT | SPC5_MCR_MDIS |
                      SPC5_SPI_DSPI9_MCR;
#endif
#if (SPC5_SPI_DMA_MODE == SPC5_SPI_DMA_NONE)
