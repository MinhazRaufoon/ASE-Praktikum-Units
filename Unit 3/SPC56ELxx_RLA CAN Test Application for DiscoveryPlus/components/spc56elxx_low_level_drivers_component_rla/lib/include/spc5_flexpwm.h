...
#define SPC5_FLEXPWM_0      (*(volatile struct spc5_flexpwm *)SPC5_FLEXPWM0_BASE)
#endif

#if (SPC5_HAS_FLEXPWM1 == TRUE) || defined(__DOXYGEN__)
#define SPC5_FLEXPWM_1      (*(volatile struct spc5_flexpwm *)SPC5_FLEXPWM1_BASE)
#endif

#if (SPC5_HAS_FLEXPWM2 == TRUE) || defined(__DOXYGEN__)
#define SPC5_FLEXPWM_2      (*(volatile struct spc5_flexpwm *)SPC5_FLEXPWM2_BASE)
#endif
/** @} */
